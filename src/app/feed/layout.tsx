...
export const metadata: Metadata = {
  ...
  description:
    "The latest public sports betting tips — football, tennis and more — from tipsters with verified, sample-size-adjusted track records. Follow the picks that have an edge.",
